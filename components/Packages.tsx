    ...
    return (
        <section className="relative h-[50vh] min-h-[400px] max-h-[600px] w-full text-white overflow-hidden">
            ...
            <div className="relative z-10 container-wide h-full flex flex-col items-center justify-center text-center">
                <h1 className="fluid-h1 font-magilio text-white mb-4 animate-fade-in-down">
                    Surf & Yoga Packages
                </h1>
...
const PackagesPage: React.FC<{ packages: Package[], isLoading: boolean, setPage: (page: string) => void }> = ({ setPage }) => (
  <div className="animate-page-fade-in">
    ...
    <section className="py-16 md:py-24 bg-white dark:bg-dark-slate">
      <div className="container-wide text-center">
          <h2 className="fluid-h2 font-magilio text-title-blue dark:text-ocean-blue mb-8">
              A Unique Destination, Great Experience
          </h2>
          <p className="fluid-p text-charcoal-gray dark:text-gray-300 max-w-4xl mx-auto mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-16">
              {/* Refactored card layout example */}
              <div className="bg-light-gray-blue dark:bg-gray-800 rounded-2xl p-8 flex flex-col items-center text-center shadow-sm">
                  ...
                  <button onClick={() => setPage('Contact')} className="w-full py-3 bg-ifni-gold text-white rounded-full font-bold hover:scale-105 transition-transform">Book Now</button>
              </div>
